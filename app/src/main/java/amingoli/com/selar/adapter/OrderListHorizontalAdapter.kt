...
import kotlinx.android.synthetic.main.item_order_horizontal.view.*

class OrderListHorizontalAdapter(val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_order_horizontal, parent, false)
